...
using Galaxy.Taurus.GoodInfoAPI.ConsulExtensions;
using Galaxy.Taurus.GoodInfoAPI.Dependency;
...
namespace Galaxy.Taurus.GoodInfoAPI
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddGalaxyAuth("GoodInfoManage");
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "GoodInfoServiceAPI", Version = "v1" });
                //c.SwaggerDoc("v2", new Info { Title = "GoodInfoServiceAPI_2", Version = "v2" });
                c.IncludeXmlComments(AppDomain.CurrentDomain.BaseDirectory + "/Galaxy.Taurus.GoodInfoAPI.xml");
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime lifetime)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "GoodInfoAPI V1");
                //c.SwaggerEndpoint("/swagger/v2/swagger.json", "GoodInfoAPI V2");
            });
        }
    }
}
